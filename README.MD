...
Normandy SingleFile helps you to save a complete web page into a single HTML
file. Normandy SingleFile is a Web Extension (and a CLI tool) compatible with Chrome, Firefox
